        ...
        <main className="flex items-center justify-center min-h-[calc(100vh-120px)] px-6 lg:px-8">
          <div className="max-w-5xl mx-auto text-center">
            <div className="space-y-8">
              <div className={`animate-fadeInUp ${isLoaded ? 'opacity-100' : 'opacity-0'}`} style={{ animationDelay: '0.2s' }}>
                <span
              ...
              <div className={`animate-fadeInUp ${isLoaded ? 'opacity-100' : 'opacity-0'}`} style={{ animationDelay: '0.4s' }}>
              ...
              <div className={`animate-fadeInUp ${isLoaded ? 'opacity-100' : 'opacity-0'}`} style={{ animationDelay: '0.6s' }}>
                <p
                ...
                >
                  ...
                  junior software engineer focused on scalable code and
                  shipping real-world products that solve meaningful problems.
                </p>
              </div>

              <div className={`animate-fadeInUp flex flex-col sm:flex-row gap-4 justify-center items-center pt-8 ${isLoaded ? 'opacity-100' : 'opacity-0'}`} style={{ animationDelay: '0.8s' }}>
                <button
                  className={`group px-8 py-4 rounded-xl font-semibold transition-all duration-300 hover:scale-105 hover:shadow-lg ${
                    isDark
              ...
              <div className={`animate-fadeInUp flex justify-center gap-6 pt-8 ${isLoaded ? 'opacity-100' : 'opacity-0'}`} style={{ animationDelay: '1s' }}>
                {[
                  { Icon: Github, href: 'https://github.com/ASLaskin', label: 'GitHub' },
                  { Icon: Linkedin, href: 'https://www.linkedin.com/in/aslaskin/', label: 'LinkedIn' },
                  { Icon: Mail, href: 'https://mail.google.com/mail/u/0/?fs=1&tf=cm&source=mailto&to=andrewlaskin6@gmail.com', label: 'Email' },
